/**
* ============================================
* PULSE ANALYTICS v15.2 - RELIABLE UPLOAD
* ============================================
* 
* BASEADO NA v15.1 CENTERED
* 
* CORREÇÕES v15.2:
* - Conexão sempre fechada (mesmo em erros)
* - WiFi desconectado após upload (evita socket travado)
* - Reconexão WiFi forçada antes de cada upload
* - Delay entre retry para roteador recuperar
* - Log de heap para debug de memória
* 
...
void uploadRawData() {
  ...
  // JSON
  sendChunk(client, "{");
  sendChunk(client, "\"device_id\": \"ESP32-S3-v15.2-Reliable\",");
...
void showWaitingScreen() {
  ...
  printCentered("v15.2 Reliable", 12);
...
void setup() {
  ...
  Serial.println("\n============================================");
  Serial.println("   PULSE ANALYTICS v15.2 - RELIABLE");
  Serial.println("   Upload com reconexão forçada");
